                ...
                <Grid item xs={10} md={8}>
                    <div className='w-full p-3 bg-white text-white shadow-md'>
                        <div className='relative'>
                            <img loading='lazy' className='w-full h-44' alt='img1' src='/Assets/Images/section4img1.png'/>
                            
                            <div className='flex flex-col items-center absolute top-0 bg-DarkBlue bg-opacity-80 text-white w-full h-full py-5 px-5'>
                                <img loading='lazy' className='my-5' alt='logo' src='/Assets/Images/logo.png' />
                        ...
                        <div className='flex flex-col  items-center my-5 text-black'>
                            ...
                            <div className='grid grid-flow-col gap-x-6 md:gap-x-8 py-5 md:px-10'>
                                <img loading='lazy' alt='brand1' src='/Assets/Images/brand1.png'/>
                                <img loading='lazy' alt='brand2' src='/Assets/Images/brand2.png'/>
                                <img loading='lazy' alt='brand3' src='/Assets/Images/brand3.png'/>
                                <img loading='lazy' alt='brand4' src='/Assets/Images/brand4.png'/>
                            </div>
                        </div>
